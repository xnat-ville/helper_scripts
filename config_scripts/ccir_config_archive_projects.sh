...
psql -h localhost -U xnat -c "delete from xhbm_configuration      where config_data=100000" $DB
psql -h localhost -U xnat -c "delete from xhbm_configuration_data where id=100000" $DB

psql -h localhost -U xnat -c "insert into xhbm_configuration_data 
...
psql -h localhost -U xnat -c "insert into xhbm_configuration
